...
(defn- default-search-results []
  (sorted-results
   [(make-result "dashboard test dashboard", :model "dashboard", :favorite false)
    ...
    (make-result "card test card", :model "card", :favorite false, :dataset_query "{}", :dashboard_count 0)
...
(def ^:private dashboard-count-results
  (letfn [(make-card [dashboard-count]
            (make-result (str "dashboard-count " dashboard-count) :dashboard_count dashboard-count,
